...
from classification_model.classification_model import ClassificationModel
...
data_file = "./data/MAGPIE_processed_partial_data_cts_" + args.data_type + "_" + args.data_stream + "_" + args.data_version + "_Round" + args.round + ".csv"
vmwe_test_file = "./data/VMWE_data_ontonotes.csv"
...
if args.mode == 'dist_eval':
    ...
    vmwe_test_data = pd.read_csv(vmwe_test_file)

    logging.basicConfig(level=logging.INFO)
    transformers_logger = logging.getLogger("transformers")
    transformers_logger.setLevel(logging.ERROR)

    train_df = train_data[["Idiom", "Context_3_Original", "Label"]]
    eval_df = valid_data[["Idiom", "Context_3_Original", "Label"]]
    test_df = test_data[["Idiom", "Context_3_Original", "Label"]]
    vmwe_test_df = vmwe_test_data[['VMWE', 'Sentence', 'Label']]
    ...
    vmwe_test_df = vmwe_test_df.rename(
        columns={"Sentence": "text_a", "VMWE": "text_b", "Label": "labels"}
    )
    ...
    vmwe_test_df['labels'] = vmwe_test_df["labels"].apply(transfer_label)
...
model_args.output_dir = "outputs_partial_" + args.data_type + "_" + args.data_stream + "_" + args.data_version + "_"+ args.model + "_" + args.order + "_Round" + args.round + "_" + args.sample
model_args.best_model_dir = model_args.output_dir + "/best_model"

base_dir = "outputs_partial_" + args.data_type + "_" + args.data_stream + "_" + args.data_version + "_"+ args.model + "_" + args.order + "_Round" + str(int(args.round)-1) + "_" + args.sample
...
if args.mode == 'dist_eval':
    ...
    with open("./data/MAGPIE_processed_data_" + args.data_type + "_" + args.data_stream + "_" + args.data_version + "_Round" + str(int(args.round) + 1) + ".csv",'w')as f:
        f_csv = csv.writer(f)
    ...
    if args.sample == 'oversample' or args.sample == 'downsample':
        ...
        oversampled_train_df = pd.DataFrame(diff_list, columns=['text_b', 'text_a', 'labels'])
    ...
    if args.model == "offline":
        ...
        with open("./results/Output_partial_" + args.data_type + "_" + args.data_stream + "_" + args.data_version + "_" + args.model + "_multipass" + "_" + args.sample + ".csv",'w') as f:
            f_csv = csv.writer(f)
        ...
        with open("./results/Output_partial_" + args.data_type + "_" + args.data_stream + "_" + args.data_version + "_" + args.model + "_Round" + args.round + "_" + args.order + "_" + args.sample + ".csv",'w') as f:
            f_csv = csv.writer(f)
            f_csv.writerow(output_headers)
            f_csv.writerows(output_row)
